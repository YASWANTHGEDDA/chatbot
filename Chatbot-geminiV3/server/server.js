...
// --- Aggressive Port Workaround ---
// If port is somehow still 5001, force it to DEFAULT_PORT (4000)
if (port === '5001' || port === 5001) {
    console.warn(`PORT is unexpectedly ${port}. Forcing to default: ${DEFAULT_PORT}`);
    port = DEFAULT_PORT;
}
// --- End Workaround ---
