    ...
    const ChatPage = ({ setIsAuthenticated }) => {
        ...
        <div className="right-sidebar">
            ...
            <div className="sidebar-content">
                {activeSidebar === 'faq' && <p>Here are some frequently asked questions...</p>}
                {activeSidebar === 'topics' && <p>Topic list or topic navigation goes here.</p>}
                {activeSidebar === 'mindmap' && <p>Mindmap view or tools will show here.</p>}
            </div>
        </div>
    )}
