    ...
    if (SpeechRecognition) {
        try {
            ...
            recognition.onresult = (event) => {
                ...
                // Append new transcript to existing input value with a space separator
                chatInput.value = chatInput.value ? chatInput.value + ' ' + transcript : transcript;
                stopListeningUI();
                // Removed automatic send to chat on recognition result
                // User will manually send by clicking send button
                // handleSendMessage();
            };
    ...
    async function handleAnalysis(analysisType) {
        ...
        try {
            ...
            if (analysisType === 'faq' || analysisType === 'topics') {
                ...
                console.log("Processing mindmap analysis...");
